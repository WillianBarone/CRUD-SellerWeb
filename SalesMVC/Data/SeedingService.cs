...
namespace SalesMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Bob Brown", "Bob@gmail.com", new DateTime(1998,4,21), 2301.40, d2);
            Seller s2 = new Seller(2, "Maria Grey", "Maria@gmail.com", new DateTime(1997,4,21), 1950.50, d1);
            Seller s3 = new Seller(3, "Alex Green", "Alex@gmail.com", new DateTime(1999,4,21), 1902.70, d4);
            Seller s4 = new Seller(4, "Martha Red", "Martha@gmail.com", new DateTime(1987,4,21), 2021.30, d3);
            Seller s5 = new Seller(5, "Donald Blue", "Donald@gmail.com", new DateTime(1978,4,21), 3063.20, d2);
            Seller s6 = new Seller(6, "Willian Black", "Mario@gmail.com", new DateTime(1993,10,23), 2180.43, d1);
